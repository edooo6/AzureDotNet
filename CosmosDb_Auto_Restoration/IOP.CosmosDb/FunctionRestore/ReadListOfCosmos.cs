...
{
    public class ReadListOfCosmosDb
    {
        ...
        public static async System.Threading.Tasks.Task<object> RetrieveFromAzureStorageAsync()
        {
            try
            {
                ...
                while (true)
                {
                    TableOperation retrieveTable = TableOperation.Retrieve<TableData>(i.ToString(), i.ToString());
                    i++;
                    ...
                    var rawCosmosName = cosmosName.ToString();
